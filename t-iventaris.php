...
<h3>Form Tambah Data Iventaris</h3>
...
<div class="form-group col-md-4">
    ...
    <input class="col-sm-4" type="text" name="" id="service"><br>
    <p>.Bulan (kosongkan jika barang bertipe habis pakai</p>
</div><br>
<div class="form-group">
...
<hr>
<div class="form-group col-md-6">
    <a href="beranda.php?page=iventaris"><button class="btn btn-danger">Cancel</button></a>
</div>
<div class="form-group col-md-6">
